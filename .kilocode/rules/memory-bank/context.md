...
- [x] Invoice Manager app at `/invoice` route with full CRUD, PDF export, localStorage persistence, search/filter
...
| 2026-03-08 | Fixed PDF download (again): switched to dynamic `import()` inside `handleDownloadPDF` for reliable browser-side loading; added try/catch error handling |
